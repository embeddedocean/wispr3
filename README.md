...
Firmware binary files (an other formats) can be found at [https://github.com/embeddedocean/wispr3/tree/Release](https://github.com/embeddedocean/wispr3/tree/main/Release)
